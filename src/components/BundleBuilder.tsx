    ...
    <section className="mx-auto mt-14 max-w-6xl px-4">
      ...
      {choosingProduct && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="anim-slide-up absolute inset-x-0 bottom-0 mx-auto max-w-md rounded-t-3xl bg-white p-5 pb-safe md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:rounded-3xl">
